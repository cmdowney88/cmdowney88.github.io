...
\vspace{2em}
\noindent {\bf Q3: LSTM Cell} An LSTM cell computes the next hidden state and \emph{memory} based on the previous hidden state and memory together with the current input.  Please consult \href{https://cmdowney88.github.io/teaching/uw_574/slides/9_lstm.pdf}{these slides} for the entire set of equations (and details about motivation).
