...
\date{\vspace{-0.2in}Due 11pm on September 28, 2026}
\maketitle
...
This section is designed to practice the Calculus pre-requisites that we briefly reviewed in class. You don't need to have derivative rules memorized, but you should be comfortable computing derivatives and partial derivatives given access to a list of the rules. There are many good ``cheat sheets'' online, as well as the slide provided at the end of our lecture on Perceptrons.
